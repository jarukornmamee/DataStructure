...
for i in range (0,len(x)):
    ...
    ## Test Bucket Sort
    print("Random Counting Sort")
    start = current_time()
    countingsort(data1,max(data1))
    end = current_time()
...
for i in range (0,len(x)):
    ...
    ## Test Bucket Sort
    print("Order Counting Sort")
    start = current_time()
    countingsort(data2,max(data2))
    end = current_time()
    print ("Elapse time: %d mil.seconds" % (end - start))
    print()
...
for i in range (0,len(x)):
    ...
    data3 = data[:]
    ## Test Bucket Sort
    print("Reverse Counting Sort")
    start = current_time()
    countingsort(data3,max(data3))
    end = current_time()
    print ("Elapse time: %d mil.seconds" % (end - start))
    print()
